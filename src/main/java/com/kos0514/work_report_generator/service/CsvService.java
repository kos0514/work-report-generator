 ...
 * <p>
 * このクラスは作業記録CSVファイルや祝日データCSVファイルの読み込み機能を提供します。
 * </p>
 */
@Service
public class CsvService {
     ...
     * </p>
     * <p>
     * 例: 2025/06/02,09:30,17:45,1:00,システム設計書作成
     * </p>
     * 
    ...
    public List<Holiday> readHolidayCsv(String csvFilePath) {
        ...
        try (CSVReader reader = new CSVReader(new InputStreamReader(new FileInputStream(csvFilePath), Charset.forName("Shift_JIS")))) {
            String[] line;
            boolean isHeader = true;
